...
public class FullTest extends Server {
    ...
    public void fullScenarioFlowPositive() {
        ...
        assertEquals("Must return header Moved Permanently",
                "Moved Permanently", response.getStatusText());
        assertEquals("Header Location must exist and contain right URL",
                "https://twitter.com/artemnikitin", response.getHeader("Location"));
    }
